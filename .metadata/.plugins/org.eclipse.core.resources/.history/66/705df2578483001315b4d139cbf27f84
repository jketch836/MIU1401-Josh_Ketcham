			...
			[
				{
					...
					rating: "PG-13",
					score: "8.0/10",
					moviePic: "posters/avengers.jpg",
					bannerPic:"banner/the-avengers-22.jpg",
					studio:"Marvel Studios, Universal Studios", 
					release: "2012",
					synopsis: "When an unexpected enemy emerges that threatens global safety and security, Nick Fury, Director of the international peacekeeping agency S.H.I.E.L.D., finds himself needing a team to pull the world back from the brink of disaster. Marvel's The Avengers is packed with action, adventure and spectacular special effects that’ll knock your socks off."
				}
			],
		"reviewRow1":
			[
