			...
			[
				{
					...
					date:"Date: Nov 21, 2008",
					review: "Review: A supremely confident, well-tooled entertainment. It's bound to be the early pace-maker for the oncoming glut of summer blockbusters."
				},
				{
					...
					date:"Date: Jun 24, 2010",
					review: "Review: Broad, loud, straight-ahead and raucous. The incredible Hulk may not be the smoothest or smartest movie ever made, but it sure captures the spirit of its giant green protagonist."
				},
				{
					title:"Iron Man 2", 
					rating: "PG-13",
					...
					date:"Date: Jul 7, 2010",
					review: "Review: The general excellence of the casting trumps the inarguable excellence of the technology."
				},
				{
					title:"Thor", 
					rating: "PG-13",
					...
					date:"Date: May 9, 2011",
					review: "Review: A giant notch up is Hiddleston, who'd make a good Edmund in King Lear: You register the chip on his shoulder rather than the villainy."
				},
				{
					...
					date:"Date: Jul 22, 2011",
					review: "Review: The only problem is that we've been there -- been nearly everywhere Captain America goes -- in countless previous movies."
				},
				{
					title:"The Avengers", 
					rating: "PG-13",
					...
					name: "Name: Tom Charity",
					news: "News Station: CNN",
					date:"Date: May 8, 2012",
					review: "Review: Never underestimate the entertainment value of the Hulk Smash."
				},
				{
					title:"Iron Man 3", 
					rating: "PG-13",
					...
					date:"Date: May 2, 2013",
					review: "Review: By even posing questions of identity, the film creates the kind of jeopardy we can believe in, and for a superhero movie, that is an accomplishment in and of itself."
				},
				{
					...
					date:"Date: Nov 15, 2013",
					review: "Review: Dimensions collide, and Taylor allows the film to hurtle with the force of Thor's hammer into pure popcorn-spectacle territory."
				}
			],	
	},
		"Xmen":
			...
			[
				{
					...
					date:"Date: Jul 7, 2010",
					review: "Review: A distinctively absorbing entertainment, offering just enough popcorn thrills for mass audiences and just enough chewiness for hardcore sci-fi fans."
				},
				{
					...
					news: "News Station: New York Magazine",
					date:"Date: Jun 24, 2010",
					review: "Review: The best new addition to the corp is Alan Cumming's Nightcrawler. His pointy ears, yellow eyes, and blue skin make him the most creepily beautiful presence in the pageant."
				},
				{
					...
					date:"Date: Apr 25, 2007",
					review: "Review: [I] found myself strangely moved by the sense of relationships, friendly and unfriendly, coming to an end in a dull return to normality in the world of humans and mutants."
				},
				{
					title:"X-Men Origins: Wolverine", 
					rating: "PG-13",
					score: "5.1/10",
					moviePic: "posters/xmen_or_wolverine.jpg",
					bannerPic:"banner/X-Men-Origins-Wolverine-hugh-jackman-as-wolverine-19589984-2000-866.jpg",
					studio:"Twentieth Century Fox Film Corp, Marvel Entertainment", 
					release: "2009",
					...
					news: "News Station: New York Observer",
					date:"Date: Jan 4, 2010",
					review: "Review: Did the plot points stick in my head five minutes after leaving the theater? Not so much ... but I know I was having fun while watching."
				},
				{
					title:"X-Men: First Class", 
					rating: "PG-13",
					score: "5.1/10",
					moviePic: "posters/xmen_fc.jpg",
					...
					date:"Date: Jun 2, 2011",
					review: 'Review: "First Class" happily delivers on the escapism and rich narrative texture the best of its predecessors have promised.'
				},
				{
					title:"The Wolverine", 
					rating: "PG-13",
					score: "6.3/10",
					moviePic: "posters/the_wolverine1.jpg",
					bannerPic:"banner/the_wolverine.jpg",
					studio:"Twentieth Century Fox Film Corp, Marvel Entertainment", 
					release: "2013",
					...
					date:"Date: Jul 25, 2013",
					review: 'Review: Instead of expounding a tedious origin story or staging an epic battle for apocalyptic stakes, "The Wolverine" focuses on a specific and self-contained adventure in a richly imagined place.'
				},
			],
	},
	"Spiderman":
			...
			[
				{
					...
					name: "Name: Tom Charity",
					news: "News Station: CNN",
					date:"Date: Jul 3, 2012",
					review: "Review: At 28, Garfield's slightly older than Maguire was when he played Peter Parker in 2002, but his combination of fresh-faced innocence, nervous agitation and wry humor is immediately appealing."
				}
			],
	},
};